    ...
    <>
      <window.DesignCanvas>
        ...
        <window.DCSection id="panels" title="UI Panels" subtitle="Each panel themed to its building. Project panels include drag-and-drop image slots — drop your real screenshots or photos straight onto them.">
          ...
          <window.DCArtboard id="panel-rmaict" label="RMAICT Tower — AI Engineer Intern (KL)" width={760} height={780}>
            <window.RMAICTPanel width={760} height={780} />
          </window.DCArtboard>
          <window.DCArtboard id="panel-forge" label="The Forge — Skills" width={760} height={780}>
            <window.ForgePanel width={760} height={780} />
          </window.DCArtboard>
          <window.DCArtboard id="panel-lighthouse" label="The Lighthouse — Contact" width={760} height={780}>
            <window.LighthousePanel width={760} height={780} />
          </window.DCArtboard>
          <window.DCArtboard id="panel-athletic" label="Athletic Stadium — CFB Valuation" width={880} height={780}>
            <window.AthleticPanel width={880} height={780} />
          </window.DCArtboard>
          <window.DCArtboard id="panel-archive" label="Whispering Archive — Quote Retrieval" width={820} height={780}>
            <window.ArchivePanel width={820} height={780} />
          </window.DCArtboard>
          <window.DCArtboard id="panel-heatmap" label="Heatmap Garden — xGenius" width={820} height={780}>
            <window.HeatmapPanel width={820} height={780} />
          </window.DCArtboard>
        </window.DCSection>
      </window.DesignCanvas>
